  const DATA = [     
      ...
      { title:'ที่ 2 แปลงโซนบ้านศรีสง่า', img:'img/14.webp', map:'https://maps.app.goo.gl/s1cPxfjVnTSGaHTX6',  loc:'ต.ปงแสงทอง อ.เมือง ลำปาง', priceNum:400000, price:'400,000', type:'landhouse', area:'100 ตร.ว.', desc:'ที่ดินถมแล้ว 2 แปลงติดกัน ใกล้บ้านศรีสง่า ต.ปงแสงทอง จ.ลำปาง เนื้อที่แปลงละ 100 ตร.ว  \n\n- หน้ากว้าง 16 เมตร ลึก 25 เมตร \n- น้ำประปา/ไฟฟ้า \n- ลงตัวทั้งปลูกบ้าน/ทำธุรกิจ\n- ซื้อ 2 แปลงมีราคาพิเศษ', gallery:['img/5/0.webp','img/5/3.webp','img/5/1.webp','img/5/2.webp'] },
      ...
      { title:'โซนต้นธงชัย หลังหมู่บ้านลำปางวิว', img:'img/39.webp', map:'https://maps.app.goo.gl/cTKJAszsopCSwnbt6',  loc:'ต.ต้นธงชัย อ.เมือง ลำปาง', priceNum:987900, price:'987,900', type:'landhouse', area:'267 ตร.ว.', desc:'ที่ดินเปล่าทำเลธรรมชาติ เนื้อที่ 2 งาน 67 ตร.ว  บรรยากาศธรรมชาติ ข้างๆเป็นที่นาและบ้านสวน  \n\n- ราคา 987,900 / 3,700 ตร.ว (รวมโอน) \n- สามารถแบ่งแปลงได้ \n- พิเศษสุดๆเราถมที่ให้ฟรี  \n\n  ลูกค้าท่านใดมองหาที่ดินปลูกบ้าน บ้านสวน ใกล้ชิดธรรมชาติ แปลงนี้ตอบโจทย์มากค่ะ ', gallery:['img/32/1.webp','img/32/2.webp','img/32/3.webp','img/32/4.webp'] },
      { title:'ที่ดินเปล่า(บ้านท่าขัว)', img:'img/41.webp', map:'https://maps.app.goo.gl/WSHkG3qq3EQ8XKHJ7',  loc:'ต.ต้นธงชัย อ.เมือง ลำปาง', priceNum:987900, price:'987,900', type:'landhouse', area:'200 ตร.ว.', desc:'ที่ดินเปล่าทำเลธรรมชาติใกล้ตัวเมือง พิกัดหมู่บ้านท่าขัว เนื้อที่ 200 ตร.ว  บรรยากาศธรรมชาติ ข้างๆเป็นที่นาและบ้านสวน  \n\n- ราคา 987,900 / 3,700 ตร.ว (รวมโอน) \n- สามารถแบ่งแปลงได้ \n- พิเศษสุดๆเราถมที่ให้ฟรี  \n\n  ลูกค้าท่านใดมองหาที่ดินปลูกบ้าน บ้านสวน ใกล้ชิดธรรมชาติ แปลงนี้ตอบโจทย์มากค่ะ ', gallery:['img/34/1.webp','img/34/2.webp','img/34/3.webp','img/34/4.webp'] },
    ...
    //colousel
    const HERO_IDX = [1,2,7,8,16,15,17,18,13,14,6,19];
