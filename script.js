  const DATA = [     
      ...
      { title:'โซนต้นธงชัย หลังหมู่บ้านลำปางวิว', img:'img/41.webp', map:'https://maps.app.goo.gl/cTKJAszsopCSwnbt6',  loc:'ต.ต้นธงชัย อ.เมือง ลำปาง', priceNum:720000, price:'720,000', type:'landhouse', area:'267 ตร.ว.', desc:'ที่ดินเปล่าทำเลธรรมชาติ เนื้อที่ 2 งาน 67 ตร.ว  บรรยากาศธรรมชาติ ข้างๆเป็นที่นาและบ้านสวน  \n\n- ราคา 720,000 / 3,600 ตร.ว (รวมโอน) \n- สามารถแบ่งแปลงได้ \n- พิเศษสุดๆเราถมที่ให้ฟรี  \n-  เหมาะมาก /ปลูกบ้าน/บ้านสวน/ซื้อเก็บ ', gallery:['img/34/1.webp','img/34/2.webp','img/34/3.webp','img/34/4.webp','img/34/5.webp','img/34/6.webp','img/34/7.webp'] },
