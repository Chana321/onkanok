  const DATA = [     
      ...
      { title:'ตึก 2 คูหาแยกเฮือนสายคำ', img:'img/29.webp', map:'https://maps.app.goo.gl/bmPypberbWtJiXLw7',  loc:'ต.ต้นธงชัย อ.เมือง ลำปาง', priceNum:2600000, price:'2,600,000/ห้อง', type:'house', tag:'ตึกคูหา', area:'2 ชั้น 2 คูหา', desc:'อาคารพาณิชย์ทำเลดี แยกเฮือนสายคำ ขายต่ำกว่าราคาประเมิน มีเงินเหลือหลักแสน ทำกิจการต่อได้เดินทางสะดวก ราคาถูกขนาดนี้ไม่มีอีกแล้ว\n\n- ขายห้องละ 2.69 ล้าน (รวมโอน) \n- พร้อมอยู่ตกแต่งไว้แล้วบางส่วน \n-  สามารถทำกิจการเปิดหน้าร้านได้เลย  \n- ยินดีให้คำปรึกษาเรื่องยื่นขอสินเชื่อฟรี', gallery:['img/17/4.webp','img/17/1.webp','img/17/2.webp','img/17/3.webp'] },
    ...
    const HERO_IDX = [1,2,6,10,14,12,13,15,15,16,17,18];
